package ir.ah.app.foodlover.ui.fragment.allrestaurant.popular
...
@AndroidEntryPoint
class PopularFragment : BaseFragment<AllRestaurantViewModel>(R.layout.fragment_popular, AllRestaurantViewModel::class) {
