package ir.ah.app.foodlover.ui.fragment.allrestaurant.featured
...
@AndroidEntryPoint
class FeaturedFragment : BaseFragment<AllRestaurantViewModel>(R.layout.fragment_featured, AllRestaurantViewModel::class) {
