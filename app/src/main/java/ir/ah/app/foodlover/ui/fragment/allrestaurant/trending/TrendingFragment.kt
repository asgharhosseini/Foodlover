package ir.ah.app.foodlover.ui.fragment.allrestaurant.trending
...
@AndroidEntryPoint
class TrendingFragment : BaseFragment<AllRestaurantViewModel>(R.layout.fragment_trending, AllRestaurantViewModel::class) {
